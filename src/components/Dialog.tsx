  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        data-[state=open]:slide-in-from-top-[48%] fixed left-[50%] top-[25%]
        z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4
        border border-[hsl(264,56%,40%)] bg-[hsl(264,56%,20%)] px-8 py-6
    ...
    >
      ...
      <DialogPrimitive.Close
        className="ring-offset-background focus:ring-ring
          ...
          absolute right-3 top-2 rounded-sm opacity-70 transition-opacity
