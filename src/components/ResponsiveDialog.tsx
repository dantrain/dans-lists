...
>(({ className, children, ...props }, ref) => (
  <DialogPrimitive.Portal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        `fixed left-[50%] top-[25%] z-50 grid w-full max-w-lg translate-x-[-50%]
        translate-y-[-50%] gap-4 border border-[hsl(264,56%,40%)]
        bg-[hsl(264,56%,20%)] px-8 py-6 shadow-lg duration-200
  ...
  <DrawerPrimitive.Portal>
    ...
    <DrawerPrimitive.Content
      ...
      className={cn(
        ...
        border-[hsl(264,56%,40%)] bg-[hsl(264,56%,20%)] px-8 pb-6`,
        className,
      )}
      {...props}
    >
      <div className="mx-auto mb-2 mt-4 h-2 w-[100px] rounded-full bg-white/20" />
      {children}
    </DrawerPrimitive.Content>
  </DrawerPrimitive.Portal>
));
